...
namespace User.Grpc.Interceptors
{
    /// <summary>
    ...
    {
        // Методы, которые не требуют токена (AllowAnonymus)
        //TODO: Вынести в appsettings
        private readonly HashSet<string> _whiteListMethods = new()
        {
            "/UserProtoService/Register",
            "/UserProtoService/Login",
            "/UserProtoService/Logout"
        };
        ...
        private void ValidateJwt(ServerCallContext context)
        {
            ...
            {
                throw new RpcException(new Status(StatusCode.Unauthenticated, "JWT отсутствует, проверьте заголвок Authorization: Bearer ..."));
            }
